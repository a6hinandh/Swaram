...
• **മ്യൂവാക് (MUAC) അളവ്:**
  - 🟢 12.5 cm-ൽ കൂടുതൽ: സാധാരണ പോഷകനില
  - 🟡 11.5 - 12.5 cm: മിതമായ പോഷകാഹാരക്കുറവ് (MAM)
  - 🔴 11.5 cm-ൽ താഴെ: കഠിനമായ പോഷകാഹാരക്കുറവ് (SAM) - ഉടൻ PHC-യിലേക്ക് റഫർ ചെയ്യുക.`,
...
• 3rd Trimester-ൽ നിർബന്ധമായും ആഴ്ചതോറും BP പരിശോധിക്കുക. അയൺ ഗുളികകൾ (IFA) ഭക്ഷണത്തിന് ശേഷം കഴിക്കാൻ നിർദ്ദേശിക്കുക.`,
  ...
  hypertension: `❤️ **രക്തസമ്മർദ്ദ നിയന്ത്രണം (Hypertension / NCD Care):**
...
മുകളിലുള്ള 🔑 ബട്ടൺ അമർത്തിയോ module1-mobile/.env ഫയലിൽ EXPO_PUBLIC_GEMINI_CHATBOT_API_KEY ചേർത്തോ നിങ്ങളുടെ പുതിയ ഗൂഗിൾ ജെമിനി കീ നൽകാവുന്നതാണ്.`;
  }
